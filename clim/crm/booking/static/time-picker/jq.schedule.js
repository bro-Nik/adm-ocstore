    ...
    resetDataInDeal: function resetDataInDeal() {
      return this.each(function () {
        ...
        for (var i in saveData.schedule) {
          ...
          if (saveData.schedule[i].booking_event === saveData.booking_event) {
    ...
    addSchedule: function addSchedule(timeline, data) {
      return this.each(function () {
        ...
        var d = {
          ...
          booking_event: data.booking_event,
   ...
   /**
    ...
    _addScheduleData: function _addScheduleData(timeline, d) {
      ...
      return this.each(function () {
        ...
        if (!data.new_schedule && (data.booking_event !== saveData.booking_event)) {
        ...
        if (data.text) {
          $bar.find('.text').text(data.text);
          // $bar.find('.text').attr('title') = data.text;
        }
      ...
      return this.each(function () {
        ...
        if (row.schedule) {
          for (var i in row.schedule) {
            ...
            data.booking_event = bdata.booking_event;
    ...
    init: function init(options) {
      return this.each(function () {
        ...
        methods._saveData.apply($this, [{
          ...
          booking_event: config.booking_event
        }]);
